...
1. You should still be logged into your Client 1 VM (LON-CL1) as the **lon-cl1\admin** account and into Microsoft 365 as Holly Dickson **(holly@WWLxZZZZZZ.onmicrosoft.com)** with a password of **Pa55w.rd**.
